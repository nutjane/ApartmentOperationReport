...
public class ReportContractTerminated { 
			  ...
			  .title(//shows report title
			  	cmp.horizontalList()
			  		.add(
			  			...
			  			cmp.text("Terminated Leasing Contract").setStyle(titleStyle).setHorizontalAlignment(HorizontalAlignment.RIGHT))
			  		.newRow()
	...
	private JRDataSource createDataSource() {
		...
		//end of Collection of data
				...
				for(int i=0;i<contractData.contractCollection.size();i++){
					...
					if(contractData.contractCollection.get(i).getCheckOutDate().equals("no")==false){
