...
public class ReportContractAll { 
	...
	private void build() {	
		...
		StyleBuilder columnTitleStyle  = stl.style(boldCenteredStyle)
            	...
            	.setBackgroundColor(new Color(102, 178, 255)); //light-blue
			  ...
			  .title(//shows report title
			  	cmp.horizontalList()
			  		.add(
			  			...
			  			cmp.text("All Leasing Contract").setStyle(titleStyle).setHorizontalAlignment(HorizontalAlignment.RIGHT))
			  		.newRow()
